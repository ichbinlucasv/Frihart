...
Seventeen public claims are in. CSS leftovers `list-style` /
`white-space` are in. Next: claim another static document (not
Wikipedia / GitHub / mail). Sensible candidates: RFC 5869 (HKDF),
openbsd.org, or another OPSEC-relevant static homepage. Arch package
