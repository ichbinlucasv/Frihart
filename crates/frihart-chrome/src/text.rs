...
impl TextEngine {
    ...
    fn attrs(weight: Weight, family: FontSlot) -> Attrs<'static> {
    ...
    pub fn draw(&mut self, fb: &mut Framebuffer, text: &str, spec: DrawText) -> (i32, i32) {
        ...
        let attrs = Self::attrs(weight, FontSlot::Sans);
    ...
    pub fn draw_family(
        ...
        let attrs = Self::attrs(weight, family);
...
fn ellipsize(
    ...
    let attrs = TextEngine::attrs(weight, FontSlot::Sans);
